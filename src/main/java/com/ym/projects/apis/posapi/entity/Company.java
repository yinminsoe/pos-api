...
public class Company extends BaseEntityWithName {
    ...
    @Builder
    public Company(Long id, LocalDateTime createDate, String createBy, LocalDateTime updateDate, String updateBy, String name, Country countryName, String licenseNo, String licenseNo2, Address address, Phone phone, Tax tax) {
