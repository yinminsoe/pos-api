...
public class Item extends BaseEntityWithName {
    ...
    public Item(Long id, LocalDateTime createDate, String createBy, LocalDateTime updateDate, String updateBy, String name, Brand brand, ItemType itemType, Location location, UnitOfMeasure unitOfMeasure, String itemBarCode, byte[] image, double quantity, double sellingPrice, double costPrice) {
